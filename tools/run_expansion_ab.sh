...
run_arm /tmp/pr-base            expA-before
run_arm /home/user/puerto-rico-web expB-after
echo "===== B(补效果后) vs A(补效果前)，扩展局 ====="
node tools/paired_report.js data/paired/expB-after-lo5.jsonl data/paired/expA-before-lo5.jsonl "B:补效果后" "A:补效果前"
